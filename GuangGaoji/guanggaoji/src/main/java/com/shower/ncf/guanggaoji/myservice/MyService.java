...
public class MyService extends GTIntentService{
    ...
    public void onReceiveMessageData(Context context, GTTransmitMessage msg) {
        Log.e(TAG, "call sendFeedbackMessage ");
...
//            Log.d(TAG, "receiver payload = " + data);
            ...
            intent.setAction("com.shower.ncf.guanggaoji.video");
            intent.putExtra("com.shower.ncf.guanggaoji.video",data);
...
//            sendMessage(data, 0);
    ...
    public void onReceiveClientId(Context context, String clientid) {
        Log.e("01010010", "onReceiveClientId -> " + "clientid = " + clientid);
